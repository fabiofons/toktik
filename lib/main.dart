...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final videosReposity = VideoPostsRepositoryImpl(
      videoDataSource: LocalVideosDatasourceImpl()
    );
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(
          lazy: false,
          create: (_) => DiscoverProvider(videosRepository: videosReposity)..loadNextVideo()
        )
      ],
      child: MaterialApp(
